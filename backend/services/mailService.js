...
const sendMail = async (pseudo, email, verificationCode) => {
  ...
  const mailOptions = {
    ...
    html: `<p><span style="font-size: 12pt;">Cher utilisateur,</span></p>
    <p><span style="font-size: 12pt;">Nous vous remercions de votre inscription sur notre application.</span></p>
    <p><span style="font-size: 12pt;"> Afin de garantir la sécurité de votre compte et de confirmer votre adresse mail (${email}), veuillez trouver ci-dessous votre code de vérification :</span></p>
    <p><br><span style="font-size: 12pt;">Code de vérification :</span><br><span style="font-size: 12pt;background-color: orange; color: white; padding: 8px 16px 8px 16px; font-size: 20px; border: none; cursor: pointer;">${verificationCode}</span></p>
    <p><span style="font-size: 12pt;">Veuillez copier ce code et revenir sur l'application pour le saisir dans la page de validation.Si vous n'avez pas effectué cette inscription, veuillez ignorer ce message.</span></p>
